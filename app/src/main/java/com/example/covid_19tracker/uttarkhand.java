...
public class uttarkhand extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttarkhand);

//        tnline=findViewById(R.id.tn_line_chart);

        con_bt=findViewById(R.id.confirmed_uttarkhand_g);
        recov_bt=findViewById(R.id.recovered_uttarkhand_g);
        death_bt=findViewById(R.id.uttarkhand_death_g);

        con_bt.setOnClickListener(this);
        recov_bt.setOnClickListener(this);
        death_bt.setOnClickListener(this);
        requestQueue= Volley.newRequestQueue(this);
        tntable=findViewById(R.id.uttarkhand_state_table);

        c=findViewById(R.id.uttarkhand_confirmed);
        r=findViewById(R.id.uttarkhand_recovered);
        d=findViewById(R.id.uttarkhand_death);
        a=findViewById(R.id.uttarkhand_active);

        String url_test_vacc ="https://api.covid19india.org/v4/min/data.min.json";

        test=findViewById(R.id.tested_counts_uttark);
        vacci=findViewById(R.id.vaccinated_counts_uttark);
        JsonObjectRequest request_test= new JsonObjectRequest(Request.Method.GET, url_test_vacc, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject TT= response.getJSONObject("UT").getJSONObject("total");
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                int death[];
                try {
                    JSONObject tn = response.getJSONObject(35);
                    ...
                    for(int i=0;i<1;i++) {
                        View  tablerow = LayoutInflater.from(uttarkhand.this).inflate(R.layout.tn_row_table,null,false);
    ...
    public void onClick(View v){
        switch (v.getId()) {
            case R.id.confirmed_uttarkhand_g:
                String URL = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue1 = Volley.newRequestQueue(uttarkhand.this);

                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String date_con[];
                        tnline = findViewById(R.id.uttarkhand_bar_chart);
                        int con[];
                        ...
                        try {
                            ...
                            while (i < tn.length()) {
                                ...
                                dataValues.add(new BarEntry(j, daily.getInt("ut")));
                                i = i + 3;
                                j++;
                            }
                ...
                break;
            case R.id.recovered_uttarkhand_g:
                String URL1 = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue2 = Volley.newRequestQueue(uttarkhand.this);
                ...
                break;
            case R.id.uttarkhand_death_g:
                String URL2 = "https://api.covid19india.org/states_daily.json";
                RequestQueue request3 = Volley.newRequestQueue(uttarkhand.this);
