...
public class andaman extends AppCompatActivity implements View.OnClickListener {

    private TextView c,r,d,a,test,vacci;
    RequestQueue requestQueue;
    BarChart tnline;
    TableLayout andamantable;
...
//        tnline=findViewById(R.id.tn_line_chart);
        ...
        con_bt=findViewById(R.id.confirmed_andaman_g);
        recov_bt=findViewById(R.id.recovered_andaman_g);
        death_bt=findViewById(R.id.andaman_death_g);

        test=findViewById(R.id.tested_counts_an);
        vacci=findViewById(R.id.vaccinated_counts_an);

        con_bt.setOnClickListener(this);
        recov_bt.setOnClickListener(this);
        death_bt.setOnClickListener(this);
        requestQueue= Volley.newRequestQueue(this);
        andamantable=findViewById(R.id.andaman_state_table);

        c=findViewById(R.id.andaman_confirmed);
        r=findViewById(R.id.andaman_recovered);
        d=findViewById(R.id.andaman_death);
        a=findViewById(R.id.andaman_active);
        ...
        JsonObjectRequest request_test= new JsonObjectRequest(Request.Method.GET, url_test_vacc, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject TT= response.getJSONObject("AN").getJSONObject("total");
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                int death[];
                try {
                    JSONObject tn = response.getJSONObject(1);
                    ...
                    for(int i=0;i<1;i++) {
                        View tablerow = LayoutInflater.from(andaman.this).inflate(R.layout.tn_row_table,null,false);
    ...
    public void onClick(View v){
        switch (v.getId()) {
            case R.id.confirmed_andaman_g:
                String URL = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue1 = Volley.newRequestQueue(andaman.this);

                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String date_con[];
                        tnline = findViewById(R.id.andaman_bar_chart);
                        int con[];
                        ...
                        try {
                            ...
                            while (i < tn.length()) {
                                ...
                                dataValues.add(new BarEntry(j, daily.getInt("an")));
                                i = i + 3;
                                j++;
                            }
                            ...
                            Toast.makeText(getApplicationContext(),"Error! Check Your Internet Connection and try again Later",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(andaman.this,MainActivity.class);
                ...
                break;
            case R.id.recovered_andaman_g:
                String URL1 = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue2 = Volley.newRequestQueue(andaman.this);
                ...
                break;
            case R.id.andaman_death_g:
                String URL2 = "https://api.covid19india.org/states_daily.json";
                RequestQueue request3 = Volley.newRequestQueue(andaman.this);
