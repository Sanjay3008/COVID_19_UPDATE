...
public class tripura extends AppCompatActivity implements View.OnClickListener {
...
//        tnline=findViewById(R.id.tn_line_chart);
        ...
        con_bt=findViewById(R.id.confirmed_tripura_g);
        recov_bt=findViewById(R.id.recovered_tripura_g);
        death_bt=findViewById(R.id.tripura_death_g);

        con_bt.setOnClickListener(this);
        recov_bt.setOnClickListener(this);
        death_bt.setOnClickListener(this);
        requestQueue= Volley.newRequestQueue(this);
        tntable=findViewById(R.id.tripura_state_table);

        c=findViewById(R.id.tripura_confirmed);
        r=findViewById(R.id.tripura_recovered);
        d=findViewById(R.id.tripura_death);
        a=findViewById(R.id.tripura_active);

        String url_test_vacc ="https://api.covid19india.org/v4/min/data.min.json";

        test=findViewById(R.id.tested_counts_tri);
        vacci=findViewById(R.id.vaccinated_counts_tri);
        JsonObjectRequest request_test= new JsonObjectRequest(Request.Method.GET, url_test_vacc, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject TT= response.getJSONObject("TR").getJSONObject("total");
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                int death[];
                try {
                    JSONObject tn = response.getJSONObject(33);
                    ...
                    for(int i=0;i<1;i++) {
                        View  tablerow = LayoutInflater.from(tripura.this).inflate(R.layout.tn_row_table,null,false);
    ...
    public void onClick(View v){
        switch (v.getId()) {
            case R.id.confirmed_tripura_g:
                String URL = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue1 = Volley.newRequestQueue(tripura.this);

                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String date_con[];
                        tnline = findViewById(R.id.tripura_bar_chart);
                        int con[];
                        ...
                        try {
                            ...
                            while (i < tn.length()) {
                                ...
                                dataValues.add(new BarEntry(j, daily.getInt("tr")));
                                i = i + 3;
                                j++;
                            }
                ...
                break;
            case R.id.recovered_tripura_g:
                String URL1 = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue2 = Volley.newRequestQueue(tripura.this);
                ...
                break;
            case R.id.tripura_death_g:
                String URL2 = "https://api.covid19india.org/states_daily.json";
                RequestQueue request3 = Volley.newRequestQueue(tripura.this);
