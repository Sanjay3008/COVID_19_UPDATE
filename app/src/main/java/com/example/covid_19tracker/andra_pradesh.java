...
public class andra_pradesh extends AppCompatActivity implements View.OnClickListener {

    TextView c,r,d,a,dailyy,test,vacci;
    RequestQueue requestQueue;
    BarChart tnline;
    TableLayout andratable;
    Button con_bt,death_bt,recov_bt;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_andra_pradesh);

//        tnline=findViewById(R.id.tn_line_chart);

        con_bt=findViewById(R.id.confirmed_andra_g);
        recov_bt=findViewById(R.id.recovered_andra_g);
        death_bt=findViewById(R.id.death_andra_g);

        con_bt.setOnClickListener(this);
        recov_bt.setOnClickListener(this);
        death_bt.setOnClickListener(this);
        requestQueue= Volley.newRequestQueue(this);
        andratable=findViewById(R.id.andra_state_table);

        c=findViewById(R.id.andra_confirmed);
        r=findViewById(R.id.andra_recovered);
        d=findViewById(R.id.andra_death);
        a=findViewById(R.id.andra_active);

        String url_test_vacc ="https://api.covid19india.org/v4/min/data.min.json";

        test=findViewById(R.id.tested_counts_ap);
        vacci=findViewById(R.id.vaccinated_counts_ap);
        JsonObjectRequest request_test= new JsonObjectRequest(Request.Method.GET, url_test_vacc, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject TT= response.getJSONObject("AP").getJSONObject("total");
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                int death[];
                try {
                    JSONObject tn = response.getJSONObject(2);
                    ...
                    for(int i=0;i<1;i++) {
                        View  tablerow = LayoutInflater.from(andra_pradesh.this).inflate(R.layout.tn_row_table,null,false);
    ...
    public void onClick(View v){
        switch (v.getId()) {
            case R.id.confirmed_andra_g:
                String URL = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue1 = Volley.newRequestQueue(andra_pradesh.this);

                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String date_con[];
                        tnline = findViewById(R.id.andra_bar_chart);
                        int con[];
                        ...
                        try {
                            ...
                            while (i < tn.length()) {
                                ...
                                dataValues.add(new BarEntry(j, daily.getInt("ap")));
                                i = i + 3;
                                j++;
                            }
                ...
                break;
            case R.id.recovered_andra_g:
                String URL1 = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue2 = Volley.newRequestQueue(andra_pradesh.this);
                ...
                break;
            case R.id.death_andra_g:
                String URL2 = "https://api.covid19india.org/states_daily.json";
                RequestQueue request3 = Volley.newRequestQueue(andra_pradesh.this);
