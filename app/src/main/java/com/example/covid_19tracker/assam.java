...
public class assam extends AppCompatActivity implements View.OnClickListener {

    TextView c,r,d,a,dailyy,test,vacci;
    RequestQueue requestQueue;
    BarChart tnline;
    TableLayout assamtable;
...
//        tnline=findViewById(R.id.tn_line_chart);
        ...
        con_bt=findViewById(R.id.confirmed_assam_g);
        recov_bt=findViewById(R.id.recovered_assam_g);
        death_bt=findViewById(R.id.assam_death_g);

        con_bt.setOnClickListener(this);
        recov_bt.setOnClickListener(this);
        death_bt.setOnClickListener(this);
        requestQueue= Volley.newRequestQueue(this);
        assamtable=findViewById(R.id.assam_state_table);

        c=findViewById(R.id.assam_confirmed);
        r=findViewById(R.id.assam_recovered);
        d=findViewById(R.id.assam_death);
        a=findViewById(R.id.assam_active);
        String url_test_vacc ="https://api.covid19india.org/v4/min/data.min.json";

        test=findViewById(R.id.tested_counts_as);
        vacci=findViewById(R.id.vaccinated_counts_as);
        JsonObjectRequest request_test= new JsonObjectRequest(Request.Method.GET, url_test_vacc, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject TT= response.getJSONObject("AS").getJSONObject("total");
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                int death[];
                try {
                    JSONObject tn = response.getJSONObject(4);
                    ...
                    for(int i=0;i<1;i++) {
                        View  tablerow = LayoutInflater.from(assam.this).inflate(R.layout.tn_row_table,null,false);
    ...
    public void onClick(View v){
        switch (v.getId()) {
            case R.id.confirmed_assam_g:
                String URL = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue1 = Volley.newRequestQueue(assam.this);

                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String date_con[];
                        tnline = findViewById(R.id.assam_bar_chart);
                        int con[];
                        ...
                        try {
                            ...
                            while (i < tn.length()) {
                                ...
                                dataValues.add(new BarEntry(j, daily.getInt("as")));
                                i = i + 3;
                                j++;
                            }
                ...
                break;
            case R.id.recovered_assam_g:
                String URL1 = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue2 = Volley.newRequestQueue(assam.this);
                ...
                break;
            case R.id.assam_death_g:
                String URL2 = "https://api.covid19india.org/states_daily.json";
                RequestQueue request3 = Volley.newRequestQueue(assam.this);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            while (i < tn.length()) {
                                JSONObject daily = tn.getJSONObject(i);
                                date.add(daily.getString("date"));
                                dataValues.add(new BarEntry(j, Math.abs(daily.getInt("as"))));
                                i = i + 3;
                                j++;
                            }
