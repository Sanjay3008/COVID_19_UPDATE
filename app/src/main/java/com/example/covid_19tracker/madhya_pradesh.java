...
public class madhya_pradesh extends AppCompatActivity implements View.OnClickListener {

    TextView c,r,d,a,dailyy,test,vacci;
...
//        tnline=findViewById(R.id.tn_line_chart);
        ...
        con_bt=findViewById(R.id.confirmed_madhya_pradesh_g);
        recov_bt=findViewById(R.id.recovered_madhya_pradesh_g);
        death_bt=findViewById(R.id.madhya_pradesh_death_g);

        con_bt.setOnClickListener(this);
        recov_bt.setOnClickListener(this);
        death_bt.setOnClickListener(this);
        requestQueue= Volley.newRequestQueue(this);
        tntable=findViewById(R.id.madhya_pradesh_state_table);

        c=findViewById(R.id.madhya_pradesh_confirmed);
        r=findViewById(R.id.madhya_pradesh_recovered);
        d=findViewById(R.id.madhya_pradesh_death);
        a=findViewById(R.id.madhya_pradesh_active);

        String url_test_vacc ="https://api.covid19india.org/v4/min/data.min.json";

        test=findViewById(R.id.tested_counts_mad);
        vacci=findViewById(R.id.vaccinated_counts_mad);
        JsonObjectRequest request_test= new JsonObjectRequest(Request.Method.GET, url_test_vacc, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject TT= response.getJSONObject("MP").getJSONObject("total");
                    String tested= TT.getString("tested");
                    String va=TT.getString("vaccinated");
                    test.setText(tested);
                    vacci.setText(va);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                int death[];
                try {
                    JSONObject tn = response.getJSONObject(23);
                    ...
                    for(int i=0;i<1;i++) {
                        View  tablerow = LayoutInflater.from(madhya_pradesh.this).inflate(R.layout.tn_row_table,null,false);
    ...
    public void onClick(View v){
        switch (v.getId()) {
            case R.id.confirmed_madhya_pradesh_g:
                String URL = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue1 = Volley.newRequestQueue(madhya_pradesh.this);

                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String date_con[];
                        tnline = findViewById(R.id.madhya_pradesh_bar_chart);
                        int con[];
                        ...
                        try {
                            ...
                            while (i < tn.length()) {
                                ...
                                if(daily.get("mp").toString().length()==0){
                                    dataValues.add(new BarEntry(j, 0));
                                }
                                else{
                                    dataValues.add(new BarEntry(j, daily.getInt("mp")));
                                }
                                i = i + 3;
                                j++;
                            }
                ...
                break;
            case R.id.recovered_madhya_pradesh_g:
                String URL1 = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue2 = Volley.newRequestQueue(madhya_pradesh.this);
                ...
                break;
            case R.id.madhya_pradesh_death_g:
                String URL2 = "https://api.covid19india.org/states_daily.json";
                RequestQueue request3 = Volley.newRequestQueue(madhya_pradesh.this);
