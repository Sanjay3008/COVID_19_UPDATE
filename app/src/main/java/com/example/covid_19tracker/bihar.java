...
public class bihar extends AppCompatActivity implements View.OnClickListener {

    TextView c,r,d,a,dailyy,test,vacci;
    RequestQueue requestQueue;
    BarChart tnline;
    TableLayout bihartable;
...
//        tnline=findViewById(R.id.tn_line_chart);
        ...
        con_bt=findViewById(R.id.confirmed_bihar_g);
        recov_bt=findViewById(R.id.recovered_bihar_g);
        death_bt=findViewById(R.id.bihar_death_g);

        con_bt.setOnClickListener(this);
        recov_bt.setOnClickListener(this);
        death_bt.setOnClickListener(this);
        requestQueue= Volley.newRequestQueue(this);
        bihartable=findViewById(R.id.bihar_state_table);

        c=findViewById(R.id.bihar_confirmed);
        r=findViewById(R.id.bihar_recovered);
        d=findViewById(R.id.bihar_death);
        a=findViewById(R.id.bihar_active);
        String url_test_vacc ="https://api.covid19india.org/v4/min/data.min.json";

        test=findViewById(R.id.tested_counts_bi);
        vacci=findViewById(R.id.vaccinated_counts_bi);
        JsonObjectRequest request_test= new JsonObjectRequest(Request.Method.GET, url_test_vacc, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject TT= response.getJSONObject("BR").getJSONObject("total");
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                int death[];
                try {
                    JSONObject tn = response.getJSONObject(5);
                    ...
                    for(int i=0;i<1;i++) {
                        View  tablerow = LayoutInflater.from(bihar.this).inflate(R.layout.tn_row_table,null,false);
    ...
    public void onClick(View v){
        switch (v.getId()) {
            case R.id.confirmed_bihar_g:
                String URL = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue1 = Volley.newRequestQueue(bihar.this);

                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String date_con[];
                        tnline = findViewById(R.id.bihar_bar_chart);
                        int con[];
                        ...
                        try {
                            ...
                            while (i < tn.length()) {
                                ...
                                dataValues.add(new BarEntry(j, daily.getInt("br")));
                                i = i + 3;
                                j++;
                            }
                ...
                break;
            case R.id.recovered_bihar_g:
                String URL1 = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue2 = Volley.newRequestQueue(bihar.this);
                ...
                break;
            case R.id.bihar_death_g:
                String URL2 = "https://api.covid19india.org/states_daily.json";
                RequestQueue request3 = Volley.newRequestQueue(bihar.this);
