...
public class meghalaya extends AppCompatActivity implements View.OnClickListener {
...
//        tnline=findViewById(R.id.tn_line_chart);
        ...
        con_bt=findViewById(R.id.confirmed_meghalaya_g);
        recov_bt=findViewById(R.id.recovered_meghalaya_g);
        death_bt=findViewById(R.id.meghalaya_death_g);

        con_bt.setOnClickListener(this);
        recov_bt.setOnClickListener(this);
        death_bt.setOnClickListener(this);
        requestQueue= Volley.newRequestQueue(this);
        tntable=findViewById(R.id.meghalaya_state_table);

        c=findViewById(R.id.meghalaya_confirmed);
        r=findViewById(R.id.meghalaya_recovered);
        d=findViewById(R.id.meghalaya_death);
        a=findViewById(R.id.meghalaya_active);

        String url_test_vacc ="https://api.covid19india.org/v4/min/data.min.json";

        test=findViewById(R.id.tested_counts_meg);
        vacci=findViewById(R.id.vaccinated_counts_meg);
        JsonObjectRequest request_test= new JsonObjectRequest(Request.Method.GET, url_test_vacc, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject TT= response.getJSONObject("ML").getJSONObject("total");
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                int death[];
                try {
                    JSONObject tn = response.getJSONObject(21);
                    ...
                    for(int i=0;i<1;i++) {
                        View  tablerow = LayoutInflater.from(meghalaya.this).inflate(R.layout.tn_row_table,null,false);
    ...
    public void onClick(View v){
        switch (v.getId()) {
            case R.id.confirmed_meghalaya_g:
                String URL = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue1 = Volley.newRequestQueue(meghalaya.this);

                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        String date_con[];
                        tnline = findViewById(R.id.meghalaya_bar_chart);
                        int con[];
                        ...
                        try {
                            ...
                            while (i < tn.length()) {
                                ...
                                dataValues.add(new BarEntry(j, daily.getInt("ml")));
                                i = i + 3;
                                j++;
                            }
                ...
                break;
            case R.id.recovered_meghalaya_g:
                String URL1 = "https://api.covid19india.org/states_daily.json";
                RequestQueue requestQueue2 = Volley.newRequestQueue(meghalaya.this);
                ...
                break;
            case R.id.meghalaya_death_g:
                String URL2 = "https://api.covid19india.org/states_daily.json";
                RequestQueue request3 = Volley.newRequestQueue(meghalaya.this);
